...
\documentclass[Junlampaper, portrait]{Julam_PosterK}
\usepackage{kotex}
    ...
    % \begin{tikzpicture}[remember picture, overlay]%
        ...
        \node at (4.5, 30.3) 
            {\includegraphics[width=4cm, height=4cm]
                {images/gshslogo1.png}};
        \node [inner sep=0pt] at (30.2, 26.6) 
            {\includegraphics[width=3cm, height=3cm]
                {./images/gshslogo.png}};
        
        \node [text=green] (students) at (20.5, 28.6) {\bf \LARGE{출 품 자 : }}; %at (가로, 세로)
        \node [text=black] (studentsname) at (23.5, 28.6) {\bf \LARGE{남도현, 백효송, 이시현}}; 
        \node [text=green] (advisor) at (20.5, 27.2) {\bf \LARGE{지도교사: }};
        \node [text=black] (advisorname) at (23.5, 27.2) {\bf \LARGE{박 기 현}};
    \end{tikzpicture}
}
