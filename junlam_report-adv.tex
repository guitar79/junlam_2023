...
\begin{document}
	...
	\include{sub/1_introduction} % 서론
	\include{sub/2_theoritical_background} % 이론적 배경
	\include{sub/3_method_of_the_study} % 연구 과정
	\include{sub/4_result_and_discussion} % 결과 및 토의
	%\include{sub/5_conclusion} % 결론
    \include{sub/6_further_study} % 추후 연구
	\include{sub/7_appendix} % 부록
