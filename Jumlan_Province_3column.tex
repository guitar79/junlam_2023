...
\small{2. 파고계\\}
    ...
    \begin{figure}[H]
        \includegraphics[width=0.325\textwidth, height=1.4cm]{images/sopagi2.jpg}
        \includegraphics[width=0.325\textwidth, height=1.4cm]{images/sopagi1.jpg}
        \includegraphics[width=0.325\textwidth, height=1.4cm]{images/Wave_Gauge.jpg}
        \caption{\tiny (a) 플라스틱 바구니에 철수세미와 벽돌을 담은 모습, (b) 플라스틱 바구니를 수직으로 쌓아 올린 모습 (c) 파고를 측정하는 모습}
        \label{wave absorb} 
        \begin{tikzpicture} [remember picture, overlay, anchor=north west, inner sep=0pt]
            \node [%draw=yellow, 
                    text=yellow,
                    ] at (0.1, 2.5) {\scriptsize{(a)}};
            \node [%draw=yellow, 
                    text=yellow,
                    ] at (2.5, 2.5) {\scriptsize{(b)}};
            \node [%draw=yellow, 
                    text=yellow,
                    ] at (5, 2.5) {\scriptsize{(c)}};
            \end{tikzpicture}	        
    \end{figure}
    
\small{3. 해안 경사\\}
    \scriptsize {해저에서 해안으로 이어지는 구조를 모형화 하여 해안 경사로를 설치할 수 있다. 긴 아크릴 판에 알루미늄 프로파일로 지지대를 만들어 높이와 기울기를 조절할 수 있도록 설계하였으며 그림 \ref{Fig:TankSlope} 속 경사로는 높이 $200\mathrm{~mm}$, 길이 $2,000\mathrm{~mm}$로 기울기가 1/10이다.}
...
\small {1. 구동부\\}
    ...
    \begin{figure}[H]
            \includegraphics[width=0.545\textwidth]{images/jopagi.jpg} 
        ...
        \begin{tikzpicture} [remember picture, overlay, anchor=north west, inner sep=0pt]
            \node [%draw=yellow, 
                    text=yellow,
                    ] at (0.1, 4) {\scriptsize{(a)}};
            \node [%draw=yellow, 
                    text=yellow,
                    ] at (4.1, 4) {\scriptsize{(b)}};
        \end{tikzpicture}	 
    \end{figure} 
...
\small {4. 동작 모습}\\
    ...
    \begin{figure}[H]
        ...
        %     \node [draw=yellow, 
        %             text=yellow,
        %             ] at (0.1, 3.9) {\scriptsize{(a)}};
        %     \node [draw=yellow, 
        %             text=yellow,
        %             ] at (4, 3.9) {\scriptsize{(b)}};
        % \end{tikzpicture}	 
    \end{figure} 
        ...
        \begin{filecontents}{HSthm-HSmsr.dat}
            ...
            \begin{tikzpicture}[
                    ...
                    \begin{axis}[
                        ...
                        xtick={0,0.2,...,2},
                        ytick={0,0.2,...,2},
                        xlabel style={align=center, font=\sf\tiny},
                        ylabel style={align=center, font=\sf\tiny},
                        x tick label style={
...
\begin{figure}[H]
            ...
            \includegraphics[trim=0 0 0 0, clip, width=0.49\textwidth, 
                ...
                {images/vlcsnap-2023-06-29-10h35m08s932-1.png} 
        \caption{(a) 조파기 동작 모습 (b) 파도 생성 모습}
        \label{result}   
        \begin{tikzpicture} [remember picture, overlay, anchor=north west, inner sep=0pt]
            \node [%draw=yellow, 
                    text=yellow,
                    ] at (0.1, 4.3) {\scriptsize{(a)}};
            \node [%draw=yellow, 
                    text=yellow,
                    ] at (4, 4.3) {\scriptsize{(b)}};
         \end{tikzpicture}	 
    \end{figure}    
\end{posterbox}
