...
\documentclass[Junlampaper, portrait]{Julam_Korea}
\usepackage{kotex}
...
\background{
    ...
    % \begin{tikzpicture}[remember picture, overlay]%
        ...
        \node at (20.0, 26.6) 
            {\includegraphics[width=13.1cm, height=3cm]
                {images/Experiment_System_Crop}};
        \node [draw=yellow, text=yellow] (TV1) at (22.0, 29.0) {\tiny{TV1}}; %at (가로, 세로)
        \node [draw=yellow, text=yellow] (TV2) at (30.5, 28.8) {\tiny{TV2}};
        \node [draw=yellow, text=yellow] (computer) at (20.6, 27.8) {\tiny{computer}};
        \node [draw=yellow, text=yellow] (camera1) at (23.7, 27.5) {\tiny{camera1}};
        \node [draw=yellow, text=yellow] (camera1) at (27.7, 27.5) {\tiny{camera2}}; 
    \end{tikzpicture}
}
...
%the Eye Catcher (the logo on the left)
{
  ...
  %\includegraphics[height=0.5\headerheight]{images/gshslogo1.png}
}
%the poster title
...
% }
%the author(s)
{\qquad \qquad \color{blue}\HUGE{연안 환경 모형 실험을 위한 2차원 조파 수조 제작 }}
...
\begin{posterbox}[name=wtank,span=2,column=2,row=0] {작품 설명: A. 2차원 조파 수조 (길이 확장 가능)}
\begin{figure}[H]
